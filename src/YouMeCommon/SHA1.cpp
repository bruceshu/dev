...
#define SHABLK0(i) \
(m_block->l[i] = (ROL32(m_block->l[i], 24) & 0xFF00FF00) | (ROL32(m_block->l[i], 8) & 0x00FF00FF))
#else  
...
namespace youmecommon
{
	...
	XString CSHA1::GetHash() const
	{
		return CStringUtil::bytes_to_hex_string(m_digest, 20);
	}
}
#pragma warning(pop) 