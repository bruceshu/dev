...
YouMeApplication_iOS::YouMeApplication_iOS ()
{
    ...
    m_deviceNameMap[("iPhone8,4")] = ("iPhone SE");
    m_deviceNameMap[("iPhone9,1")] = ("iPhone 7");
    m_deviceNameMap[("iPhone9,3")] = ("iPhone 7");
    m_deviceNameMap[("iPhone9,2")] = ("iPhone 7 Plus");
    m_deviceNameMap[("iPhone9,4")] = ("iPhone 7 Plus");
...
XString YouMeApplication_iOS::getCpuChip ()
{
    return "";
}
...
XString YouMeApplication_iOS::getCachePath()
{
    ...
    const char *path_cstr = [[NSFileManager defaultManager] fileSystemRepresentationWithPath:cachePath];
    if (nullptr == path_cstr) {
        return "";
    }
    XString documentDirectory = path_cstr;
