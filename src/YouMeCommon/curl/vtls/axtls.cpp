...
#include "curl/inet_pton.h"
#include "vtls.h"
#include "curl/parsedate.h"
#include "curl/connect.h" /* for the connect timeout */
#include "curl/select.h"
...
namespace youmecommon
{
		...
		CURLcode *err)
	{
		...
		int rc = ssl_write(conn->ssl[sockindex].ssl, (const uint8_t*)mem, (int)len);
